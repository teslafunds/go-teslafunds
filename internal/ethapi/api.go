...
// ProtocolVersion returns the current Dubaicoin protocol version this node supports
...
// Sign calculates a Dubaicoin ECDSA signature for:
...
//
// https://github.com/dubaicoin-dbix/go-dubaicoin/wiki/Management-APIs#personal_sign
...
//
// https://github.com/dubaicoin-dbix/go-dubaicoin/wiki/Management-APIs#personal_ecRecover
...
// PublicBlockChainAPI provides an API to access the Dubaicoin blockchain.
// It offers only methods that operate on public data that is freely available to anyone.
...
// Version returns the current dubaicoin protocol version.
