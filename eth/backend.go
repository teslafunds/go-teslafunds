...
import (
	...
	"github.com/teslafunds/go-teslafunds/core/bloombits"
	...
	"github.com/teslafunds/go-teslafunds/eth/filters"
	...
	"github.com/teslafunds/go-teslafunds/internal/ethapi"
...
func New(ctx *node.ServiceContext, config *Config) (*Ethereum, error) {
	...
	log.Info("Initialising Teslafunds protocol", "versions", ProtocolVersions, "network", config.NetworkId)
