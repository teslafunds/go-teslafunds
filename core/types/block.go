...
// Package types contains data types related to Teslafunds consensus.
=======
...
// Header represents a block header in the Dubaicoin blockchain.
type Header struct {
...
// Block represents an entire block in the Dubaicoin blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// "external" block encoding. used for tsf protocol, etc.
...
// DecodeRLP decodes the Dubaicoin
...
// EncodeRLP serializes b into the Dubaicoin RLP block format.
