// Copyright 2016 The go-ethereum / go-teslafunds Authors
// This file is part of the go-ethereum / go-teslafunds library.
//
// The go-ethereum / go-teslafunds library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// The go-ethereum / go-teslafunds library is distributed in the hope that it will be useful,
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an Teslafunds user, either
