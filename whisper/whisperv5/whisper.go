...
// Whisper represents a dark communication interface through the Dubaicoin
...
// New creates a Whisper client ready to communicate through the Dubaicoin P2P network.
