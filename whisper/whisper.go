...
import (
	...
	"github.com/teslafunds/go-teslafunds/event/filter"
...
// Whisper represents a dark communication interface through the Teslafunds
...
// New creates a Whisper client ready to communicate through the Teslafunds P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
