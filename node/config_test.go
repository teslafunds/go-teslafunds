...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gtsf.ipc", false, filepath.Join(os.TempDir(), "gtsf.ipc")},
		{"data", "gtsf.ipc", false, "data/gtsf.ipc"},
		{"data", "./gtsf.ipc", false, "./gtsf.ipc"},
		{"data", "/gtsf.ipc", false, "/gtsf.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gtsf.ipc", true, `\\.\pipe\gtsf.ipc`},
		{"data", "gtsf.ipc", true, `\\.\pipe\gtsf.ipc`},
		{"data", `\\.\pipe\gtsf.ipc`, true, `\\.\pipe\gtsf.ipc`},
	}
