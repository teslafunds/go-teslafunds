...
// Welcome show summary of current Gtsf instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gtsf metadata
	fmt.Fprintf(c.printer, "Welcome to the Gtsf JavaScript console!\n\n")
	c.jsre.Run(`
