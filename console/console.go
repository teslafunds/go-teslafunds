...
<<<<<<< HEAD
	"github.com/teslafunds/go-teslafunds/internal/jsre"
	"github.com/teslafunds/go-teslafunds/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client  // RPC client to execute Dubaicoin requests through
...
func (c *Console) init(preload []string) error {
	...
	//flatten := "var eth = web3.eth; var personal = web3.personal; " //ETH DEFAULT
	flatten := "var dbix = eth = web3.eth; web3.dbix = web3.eth; var personal = web3.personal; "
	for api := range apis {
		if api == "web3" {
...
// Welcome show summary of current Gdbix instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Gdbix metadata
	fmt.Fprintf(c.printer, "Welcome to the Gdbix JavaScript console!\n\n")
	c.jsre.Run(`
