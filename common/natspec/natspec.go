...
import (
	...
	"github.com/teslafunds/go-teslafunds/xeth"
...
func GetNotice(xeth *xtsf.XEth, tx string, http *httpclient.HTTPClient) (notice string) {
...
func New(xeth *xtsf.XEth, jsontx string, http *httpclient.HTTPClient) (self *NatSpec, err error) {
...
func FetchDocsForContract(contractAddress string, xeth *xtsf.XEth, client *httpclient.HTTPClient) (content []byte, err error) {
	// retrieve contract hash from state
	codehex := xtsf.CodeAt(contractAddress)
	codeb := xtsf.CodeAtBytes(contractAddress)
...
func (self *NatSpec) Notice() (notice string, err error) {
	...
	notice, err = self.noticeForMethod(self.tx, mtsf.name, mtsf.Notice)
	return
}
