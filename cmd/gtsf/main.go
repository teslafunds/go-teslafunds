...
// gtsf is the official command-line client for Ethereum.
package main
...
func init() {
	...
	app.Copyright = "Copyright 2013-2017 The go-ethereum Authors & the go-teslafunds Authors"
...
func startNode(ctx *cli.Context, stack *node.Node) {
	...
	if ctx.GlobalBool(utils.MiningEnabledFlag.Name) {
		...
		if err := stack.Service(&ethereum); err != nil {
			utils.Fatalf("teslafunds service not running: %v", err)
		}
