...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Teslafunds presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    gtsf wallet import /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    gtsf account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    gtsf account import [options] <keyfile>
