...
import (
	...
	"github.com/dubaicoin-dbix/go-dubaicoin/swarm"
	bzzapi "github.com/dubaicoin-dbix/go-dubaicoin/swarm/api"
...
var (
	...
	app              = utils.NewApp(gitCommit, "Dubaicoin Swarm")
...
var (
	...
	EthAPIFlag = cli.StringFlag{
		Name:  "ethapi",
		Usage: "URL of the Dubaicoin API provider",
		Value: node.DefaultIPCEndpoint("gdbix"),
	}
...
func init() {
	// Override flag defaults so bzzd can run alongside gdbix.
