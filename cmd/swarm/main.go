...
import (
	...
	"github.com/teslafunds/go-teslafunds/contracts/ens"
	"github.com/teslafunds/go-teslafunds/crypto"
	"github.com/teslafunds/go-teslafunds/ethclient"
	...
	"github.com/teslafunds/go-teslafunds/swarm"
	bzzapi "github.com/teslafunds/go-teslafunds/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:  "swap-api",
		Usage: "URL of the Teslafunds API provider to use to settle SWAP payments",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		Name:  "ens-api",
		Usage: "URL of the Teslafunds API provider to use for ENS record lookups",
		Value: node.DefaultIPCEndpoint("gtsf"),
	}
...
var app = utils.NewApp(gitCommit, "Teslafunds Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-ethereum / go-teslafunds Authors"
