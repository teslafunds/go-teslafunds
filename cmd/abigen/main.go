...
var (
	abiFlag = flag.String("abi", "", "Path to the Teslafunds contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Teslafunds contract bytecode (generate deploy method)")
...
var (
	abiFlag = flag.String("abi", "", "Path to the Dubaicoin contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Dubaicoin contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")
>>>>>>> 7fdd714... gdbix-update v1.5.0

	solFlag  = flag.String("sol", "", "Path to the Teslafunds contract Solidity source to build and bind")
