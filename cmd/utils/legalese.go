...
THE USER EXPRESSLY KNOWS AND AGREES THAT THE USER IS USING THE TESLAFUNDS PLATFORM AT THE USER’S SOLE
RISK. THE USER REPRESENTS THAT THE USER HAS AN ADEQUATE UNDERSTANDING OF THE RISKS, USAGE AND
INTRICACIES OF CRYPTOGRAPHIC TOKENS AND BLOCKCHAIN-BASED OPEN SOURCE SOFTWARE, TSF PLATFORM AND TSF.
...
BY OR RELATED TO RISKS OF, USE OF, OR INABILITY TO USE, TSF OR THE TESLAFUNDS PLATFORM UNDER ANY CAUSE
...
TESLAFUNDS NOR TESLAFUNDS TEAM SHALL BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, EXEMPLARY OR
...
INJURY ARISING FROM ANY WILLFUL MISCONDUCT OR FRAUD OF STIFTUNG TESLAFUNDS.
