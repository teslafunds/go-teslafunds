...
<<<<<<< HEAD
// Package bind generates Teslafunds contract Go bindings.
//
// Detailed usage document and tutorial available on the go-ethereum Wiki page:
// https://github.com/teslafunds/go-teslafunds/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
=======
// Package bind generates Ethereum contract Go bindings.
//
// Detailed usage document and tutorial available on the go-ethereum Wiki page:
// https://github.com/dubaicoin-dbix/go-dubaicoin/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
