...
type ContractCaller interface {
	...
	// ContractCall executes a Dubaicoin contract call with the specified data as the
	// input.
...
<<<<<<< HEAD
	// ContractCall executes an Teslafunds contract call with the specified data as
...
type PendingContractCaller interface {
	...
	// PendingCallContract executes a Dubaicoin contract call against the pending state.
