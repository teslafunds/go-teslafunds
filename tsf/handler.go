...
import (
	...
	"github.com/teslafunds/go-teslafunds/tsf/fetcher"
...
func (pm *ProtocolManager) Stop() {
	glog.V(logger.Info).Infoln("Stopping teslafunds protocol handler...")
	...
	glog.V(logger.Info).Infoln("Teslafunds protocol handler stopped")
}
