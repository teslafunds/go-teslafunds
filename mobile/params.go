...
// TestnetChainConfig returns the chain configurations for the Dubaicoin test network.
...
// TestnetGenesis returns the JSON spec to use for the Dubaicoin test network.
