Name "gtsf ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/teslafunds/go-teslafunds/issues"
!define UPDATEURL "https://github.com/teslafunds/go-teslafunds/releases"
!define ABOUTURL "https://github.com/teslafunds/go-teslafunds#teslafunds-go"
...
Section "Gtsf" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gtsf.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gtsf.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Gexp incoming peers (TCP:42786)" ""  6 1 1 2147483647 1 "$INSTDIR\gtsf.exe" "" "" "Teslafunds" 42786 "" "" ""
  SimpleFC::AdvAddRule "Gexp outgoing peers (TCP:42786)" ""  6 2 1 2147483647 1 "$INSTDIR\gtsf.exe" "" "" "Teslafunds" "" 42786 "" ""
  SimpleFC::AdvAddRule "Gexp UDP discovery (UDP:42786)" "" 17 2 1 2147483647 1 "$INSTDIR\gtsf.exe" "" "" "Teslafunds" "" 42786 "" ""

  # Set default IPC endpoint (https://github.com/teslafunds/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gtsf.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gtsf.ipc"
