...
# 1. install gdbix for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gdbix
# 5. create gdbix, attach and uninstall start menu entries
...
!define GROUPNAME "Dubaicoin"
!define APPNAME "Gdbix"
!define DESCRIPTION "Official Go implementation of the Dubaicoin protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gdbix is installed global
