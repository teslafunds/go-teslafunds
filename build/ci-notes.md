...
We want to build go-teslafunds with the most recent version of Go, irrespective of the Go
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/teslafunds-beta-1.5.0+xenial
...
Built packages are placed in the dist/ directory.
    ...
    $ cd ..
    $ dpkg-deb -c gtsf-beta_1.6.0+xenial_amd64.deb
